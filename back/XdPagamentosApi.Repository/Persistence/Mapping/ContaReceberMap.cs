...
namespace XdPagamentosApi.Repository.Persistence.Mapping
{
    public class ContaReceberMap : IEntityTypeConfiguration<ContaReceber>
    {
        public void Configure(EntityTypeBuilder<ContaReceber> builder)
        {
            ...
            builder.Property(c => c.DataVencimento).HasColumnName("cor_data_vencimento");
            builder.Property(c => c.DataEmissao).HasColumnName("cor_data_emissao");
            ...
            builder.Property(c => c.ValorPrevisto).HasColumnName("cor_valor_previsto");
