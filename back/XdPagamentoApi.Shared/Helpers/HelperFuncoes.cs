...
namespace XdPagamentoApi.Shared.Helpers
{
    ...
    {
        public static string ValorMoedaBRString(string valor) => string.Format(CultureInfo.GetCultureInfo("pt-BR"), "{0:N}", FormataValorDecimal(valor));
        ...
        public static decimal FormataValorDecimal(string valor) => decimal.Parse(valor.Replace(".", ""), new NumberFormatInfo() { NumberDecimalSeparator = "," });
